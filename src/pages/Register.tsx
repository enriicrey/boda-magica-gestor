          ...
          <div className="max-w-md mx-auto">
            ...
            >
              <Tabs defaultValue="info" className="w-full">
                ...
                <TabsContent value="info" className="text-center px-6 py-8 bg-white rounded-lg shadow-sm">
                ...
                <TabsContent value="request" className="px-6 py-8 bg-white rounded-lg shadow-sm">
